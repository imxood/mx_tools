...
import com.mx.speech.DataReceiveListener;
import com.mx.speech.JsonParser;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private SerialPortUtils utils = new SerialPortUtils();
...
//        });
        ...
        utils.onDataReceiveListener = new DataReceiveListener();
    ...
    private void initSpeech() {
        ...
        SpeechUtility. createUtility( this, SpeechConstant. APPID + "=5a2927e5," + SpeechConstant.FORCE_LOGIN +"=true" );
    }
...
//设置发音人（更多在线发音人，用户可参见 附录 13.2
        mTts.setParameter(SpeechConstant. VOICE_NAME, "aisjinger" ); // 设置发音人,vixyun
